...
* Fix a typo in the default configuration where the rare RARA fusion partner
  STAT3 was written as STAT3B. Note that the impact should be minimal since all
  fusions with RARA are reported when using the default configuration.
